    ...
    <div className='lg:flex justify-between items-center'>
      <div className='lg:w-1/2 p-5'>
        ...
        <p className='text-justify'>
          ...
          appointment schedule, earliest available doctors and other appointment
          related information are provided through the appointment desk. We
          offer comprehensive services from all fields of dentistry. In addition
          to high-end dental equipment, all services are provided in a
